        ...
        <div class="admin-main">
            ...
            <div style="background: #fff; padding: 30px; border-radius: 6px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); max-width: 800px;">
                <form id="editProductForm" action="<?= BASE_URL ?>/admin/product/edit/<?= $product['id'] ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div style="margin-bottom: 18px;">
                        <label style="display: block; font-size: 12px; font-weight: 600; margin-bottom: 6px;">AVAILABLE COLORS & COMBINATIONS (Comma Separated)</label>
                        <input type="text" name="colors" value="<?= htmlspecialchars($product['colors'] ?? 'Black, Red, Green & Red, Blue & Gray, Beige') ?>" style="width: 100%; padding: 12px; border: 1px solid #cbd5e0; border-radius: 4px;">
