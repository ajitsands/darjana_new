...
$router->add('GET', '/admin/subscribers', 'AdminController@subscribers');
$router->add('POST', '/admin/subscribers/delete/{id}', 'AdminController@deleteSubscriber');
$router->add('POST', '/admin/subscribers/send-promo', 'AdminController@ajaxSendPromotionalEmail');
